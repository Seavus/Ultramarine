...
namespace Ultramarine.Generators.Language
{
	...
	/// </remarks>
	public partial class GeneratorLanguageHelpKeywordHelper : GeneratorLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new GeneratorLanguageHelpKeywordHelper.
		/// </summary>
		protected GeneratorLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the GeneratorLanguageHelpKeywordHelper.
		/// </summary>
		public static GeneratorLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class GeneratorLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new GeneratorLanguageHelpKeywordHelperBase.
		/// </summary>
		protected GeneratorLanguageHelpKeywordHelperBase()
			: base() { }
