...
namespace Ultramarine.Generators.Language
{
	...
	/// </summary>
	internal partial class GeneratorLanguageCommandSet : GeneratorLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new GeneratorLanguageCommandSet.
		/// </summary>
		public GeneratorLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class GeneratorLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new GeneratorLanguageCommandSetBase.
		/// </summary>
		protected GeneratorLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewGeneratorLanguageExplorerCommand,
				typeof(GeneratorLanguageEditorFactory).GUID);
		...
		{
			GeneratorLanguageExplorerToolWindow explorer = this.GeneratorLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected GeneratorLanguageDocData CurrentGeneratorLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as GeneratorLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected GeneratorLanguageDocView CurrentGeneratorLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as GeneratorLanguageDocView;
			}
		}
		...
		/// </summary>
		protected GeneratorLanguageExplorerToolWindow GeneratorLanguageExplorerToolWindow
		{
			get
			{
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(GeneratorLanguageExplorerToolWindow), true) as GeneratorLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				GeneratorLanguageExplorerToolWindow explorerWindow = this.GeneratorLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class GeneratorLanguageClipboardCommandSet : GeneratorLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new GeneratorLanguageClipboardCommandSet.
		/// </summary>
		public GeneratorLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class GeneratorLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new GeneratorLanguageClipboardCommandSetBase.
		/// </summary>
		protected GeneratorLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
